package com.example.SpringSecurityCifrado.service;

import com.example.SpringSecurityCifrado.domain.Car;
import com.example.SpringSecurityCifrado.repository.CarRepository;
...
public class CarServiceImpl implements CarService {
    ...
    @Override
    public List<Car> findByCyearIn(List<Integer> cyear) {
        return this.carRepository.findByCyearIn(cyear);
    }

    @Override
    public List<Car> findByCyearBetween(Integer startCyear, Integer endCyear) {
        return this.carRepository.findByCyearBetween(startCyear, endCyear);
    }
